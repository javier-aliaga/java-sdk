 ...
 *
 * <p>TODO: the JSON-to-arguments binding here is a compact mirror of
 * {@code RecoveryAgentActivity#parseToolArguments}; the cutover should share one parser (or
 * adopt LangChain4j's {@code DefaultToolExecutor}) rather than keep two copies.
 */
@ApplicationScoped
