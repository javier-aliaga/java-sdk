 ...
 *
 * <p>Under {@code dapr.agentic.durable=true} this exercises the durable {@code @Output} path —
 * the `durable-parallel` workflow runs both react-agent children, then invokes {@link #combine}
 * to produce the result (the gap that left QuickResearch's {@code /research} returning empty).
 */
