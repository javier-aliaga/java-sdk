 ...
 * routing key is that same input. Under {@code dapr.agentic.durable=true} this runs as the
 * {@code durable-conditional} workflow, which evaluates the pure static conditions and runs the
 * matching sub-agent as a {@code react-agent} child.
 */
