 ...
 *
 * <p>Composites are exercised through the drop-in entry point (inject {@code @SequenceAgent} etc.
 * with {@code dapr.agentic.durable=true}); these endpoints just show the leaf react-agent path.
 *
 * <pre>
